...
public final class TokenUtils {
    ...
    public static Long getUserId(String token) {
        ...
        Long userId = JwtUtils.getPubClaimValue(token, Constants.JWT.JWT_CLAIM_KEY_USER_ID, Long.class);
        return userId;
    }
    ...
    public static int getUserType(String token) {
        Objects.requireNonNull(token, TOKEN_NOT_NULL_MSG);
        int userType = JwtUtils.getPubClaimValue(token, Constants.JWT.JWT_CLAIM_KEY_USER_TYPE, Integer.class);
        return userType;
    }
    ...
    public static String getClientDeviceType(String token) {
        Objects.requireNonNull(token, TOKEN_NOT_NULL_MSG);
        String clientDeviceType = JwtUtils.getPubClaimValue(token, Constants.JWT.JWT_CLAIM_KEY_CLIENT_DEVICE_TYPE, String.class);
